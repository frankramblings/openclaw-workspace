...
KNOWN_ENV_VARS: frozenset[str] = frozenset({
    ...
    "WORKSPACE_CLIP_MAX_BYTES",
    "WORKSPACE_CLIP_TIMEOUT_S",
    "WORKSPACE_CSP_ENFORCE",
    "WORKSPACE_DATA_DIR",
    "WORKSPACE_EMAIL_ADDRESS",
    "WORKSPACE_EMOJI_CACHE",
    "WORKSPACE_FOLLOWUP_TURNS",
    "WORKSPACE_FRONTEND_DIR",
    "WORKSPACE_LOCAL_HOST",
    "WORKSPACE_LOG_LEVEL",
    "WORKSPACE_OBSERVER",
    "WORKSPACE_OBSERVER_POLL_S",
    "WORKSPACE_OBSERVE_THRESHOLD_S",
    "WORKSPACE_PROJECT_CLASSIFY",
    "WORKSPACE_PROMISE_WAKE",
    "WORKSPACE_PROMISE_WAKE_COOLDOWN_S",
    "WORKSPACE_PROMISE_WAKE_DELAY_S",
    "WORKSPACE_RESEARCH_TURN_TIMEOUT_S",
    "WORKSPACE_SOURCE_URL",
    "WORKSPACE_STALL_CAP",
    "WORKSPACE_STALL_NOTICE",
    "WORKSPACE_SUGGEST_MODEL",
    "WORKSPACE_TITLE_MODEL",
    "WORKSPACE_TURN_TIMEOUT_S",
    "WORKSPACE_UNIT_FOLLOWER",
    "WORKSPACE_UNIT_POLL_S",
    "WORKSPACE_USER",
    "WORKSPACE_USER_NAME",
})
