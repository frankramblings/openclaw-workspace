...
export const PANELS = {
  ...
  brain: [card({ title: 'Brain', icon: TAB.brain[2], sub: "Gary's long-term memories and skills — browse, edit, pin, and audit them.", launcher: 'Open Brain', launcherAct: 'openBrain', brainPanel: true })],
